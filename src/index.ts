...
import { type CommandsRegistry, handlerAddFeed, handlerFeeds, handlerGetUsers, handlerLogin, handlerRegister, handlerReset, registerCommand, runCommand } from "./commands.js";
